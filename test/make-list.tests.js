...
test('make list of studies from html template', assert => {
    ...
    <li>
                ...
                <h3>Mission Start Date: ${study['Start Date']}</h3>
                <h3>Mission End Date: ${study['End Date']}</h3>
                <p>Project Type: ${study['Project Type']}</p>
                <p>Study Description: ${study['Study Description']}</p>
            </li>`;
